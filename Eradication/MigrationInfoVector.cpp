...
#define Vector_Migration_Filename_DESC_TEXT "Path to the vector migration file defining patterns of vector migration to adjacent nodes."
#define x_Vector_Migration_DESC_TEXT "Scale factor for the rate of vector migration to adjacent nodes."
